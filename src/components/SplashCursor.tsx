...
export default function SplashCursor({
  ...
  const { isFunModeOn } = useAppContext();
    ...
    function initFramebuffers() {
      ...
      if (!velocity && rg) {
        ...
        velocity = resizeDoubleFBO(
          ...
          simRes.width,
          simRes.height,
          rg?.internalFormat ?? (() => { throw new Error("Required texture format 'rg.internalFormat' is null or undefined."); })(),
          rg?.format ?? (() => { throw new Error("Required texture format 'rg.format' is null or undefined."); })(),
          texType,
          filtering
        );
      }
      ...
      if (!r) {
        throw new Error("Required texture format 'r' is null or undefined.");
      }
