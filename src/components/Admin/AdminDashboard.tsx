...
const StatusBadge = ({ status }: { status?: string }) => {
  ...
  const palette: Record<string, string> = {
    ...
    video_generated: "bg-emerald-500/15 text-emerald-300 border-emerald-500/30",
    processing: "bg-amber-500/15 text-amber-300 border-amber-500/30",
    audio_generation: "bg-violet-500/15 text-violet-300 border-violet-500/30",
    audio_uploaded: "bg-sky-500/15 text-sky-300 border-sky-500/30",
    awaiting_to_start_render: "bg-amber-500/15 text-amber-300 border-amber-500/30",
    video_generation: "bg-cyan-500/15 text-cyan-300 border-cyan-500/30",
