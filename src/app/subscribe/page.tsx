...
function SubscribePageContent() {
  ...
  // Referral state - stores verified referral code for checkout
  ...
  if (packages.length === 0) {
    return (
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="p-6 text-center bg-zinc-50 dark:bg-zinc-900 rounded-xl">
                          ...
                          <div key={idx} className="flex items-start gap-2 text-xs">
                            ...
                            <span
                              className={`leading-snug ${
                                isCurrentPlan || (isSelected && !activeSubscription) || (showFirstMonthPrice && isSelected)
